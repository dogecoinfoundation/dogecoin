...
class CreateTxWalletTest(BitcoinTestFramework):
    ...
    def test_tx_size_too_large(self):
        ...
        outputs = {self.nodes[0].getnewaddress(address_type='bech32'): 0.025 for _ in range(400)}
        raw_tx = self.nodes[0].createrawtransaction(inputs=[], outputs=outputs)

        for fee_setting in ['-minrelaytxfee=1.0', '-mintxfee=1.0', '-paytxfee=1.0']:
